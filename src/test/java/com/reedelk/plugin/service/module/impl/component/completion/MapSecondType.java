...
public class MapSecondType extends HashMap<String, Serializable> implements TrieProvider {
    ...
    public void register(Map<String, Trie> trieMap) {
        ...
        trie.insert(createProperty("secondProperty1", "secondProperty1", String.class.getName()));
        trie.insert(createProperty("secondProperty2", "secondProperty2", long.class.getName()));
