...
public class MyAttributeType extends MessageAttributes implements TrieProvider {
    ...
    public void register(Map<String, Trie> trieMap) {
        ...
        trie.insert(createProperty("attributeProperty1", "attributeProperty1", String.class.getName()));
        trie.insert(createProperty("attributeProperty2", "attributeProperty2", long.class.getName()));
