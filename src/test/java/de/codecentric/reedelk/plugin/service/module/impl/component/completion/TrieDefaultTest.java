...
class TrieDefaultTest extends AbstractCompletionTest {
    ...
    void shouldReturnCorrectSuggestions() {
        ...
        Suggestion method2 = SuggestionTestUtils.createFunctionSuggestion("method2", long.class.getName(), typeAndTries);
        Suggestion property1 = SuggestionTestUtils.createPropertySuggestion("myProperty", byte[].class.getName(), typeAndTries);
        Trie trie = new TrieDefault(TypeTestUtils.MyItemType.class.getName());
        trie.insert(method1);
        trie.insert(method2);
