...
class SuggestionProcessorTest {
    ...
    void shouldPopulateCorrectlyModuleTypes() {
        ...
        TypePropertyDescriptor idProperty = SuggestionTestUtils.createStringPropertyDescriptor("id");
        TypePropertyDescriptor ageProperty = SuggestionTestUtils.createIntPropertyDescriptor("age");
        TypeFunctionDescriptor method1 = SuggestionTestUtils.createFunctionDescriptor("method1", "method1(String key)", String.class.getName(), 1);
        TypeFunctionDescriptor method2 = SuggestionTestUtils.createFunctionDescriptor("method2", "method2()", int.class.getName());
        TypeDescriptor fileType = SuggestionTestUtils.createTypeDescriptor(fileTypeQualifiedName, asList(idProperty, ageProperty), asList(method1, method2));

        String documentTypeQualifiedName = "com.test.internal.type.DocumentType";
        TypePropertyDescriptor nameProperty = SuggestionTestUtils.createStringPropertyDescriptor("name");
        TypeFunctionDescriptor findMethod = SuggestionTestUtils.createFunctionDescriptor("find", "find(String key)", int.class.getName(), 1);
        TypeDescriptor documentType = SuggestionTestUtils.createTypeDescriptor(documentTypeQualifiedName, singletonList(nameProperty), singletonList(findMethod));
    ...
    void shouldPopulateCorrectlyModuleGlobalTypes() {
        ...
        TypeFunctionDescriptor method1 = SuggestionTestUtils.createFunctionDescriptor("method1", "method1(String key)", String.class.getName(), 1);
        TypeDescriptor fileType = SuggestionTestUtils.createTypeDescriptor(type, emptyList(), singletonList(method1));
