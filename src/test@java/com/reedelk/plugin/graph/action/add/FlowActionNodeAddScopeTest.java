...
class FlowActionNodeAddScopeTest extends BaseFlowActionNodeAddTest {
    ...
    void shouldCorrectlyAddUpperNodeToFirstRouterWithoutConnectingToSecondRouterLastElement() {
        ...
        List<RouterConditionRoutePair> router2ConditionRoutePairs = ListConditionRoutePairs.of(routerNode2.componentData());
        router2ConditionRoutePairs.add(new RouterConditionRoutePair("otherwise", componentNode2));
    ...
    void shouldCorrectlyAddNodeAtTheTopOfScopedNodeChild() {
        ...
        List<RouterConditionRoutePair> routerConditionRoutePairs = ListConditionRoutePairs.of(routerNode1.componentData());
        routerConditionRoutePairs.add(new RouterConditionRoutePair("1 != 2", componentNode1));
        routerConditionRoutePairs.add(new RouterConditionRoutePair("otherwise", componentNode2));
