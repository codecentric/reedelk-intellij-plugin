...
public class Colors {
    ...
    public static final Color PROPERTIES_PROPERTY_TITLE = JBColor.DARK_GRAY;
    ...
    public static final Color SCRIPT_EDITOR_INLINE_BORDER = new JBColor(Gray._192, Gray._100);
    ...
    public static final JBColor INPUT_FIELD_HINT = new JBColor(Gray._170, Gray._130);
    public static final JBColor FILE_INPUT_FIELD_HINT = FOREGROUND_TEXT;

    public static final Color TYPE_OBJECT_HORIZONTAL_SEPARATOR = SCRIPT_EDITOR_INLINE_BORDER;
