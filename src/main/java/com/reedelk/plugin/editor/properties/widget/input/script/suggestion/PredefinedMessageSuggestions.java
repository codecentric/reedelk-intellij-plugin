...
class PredefinedMessageSuggestions {
    ...
    static final List<SuggestionToken> SUGGESTIONS = Arrays.asList(
            ...
            new SuggestionToken("context.setVariable()", FUNCTION),
            new SuggestionToken("context.removeVariable()", FUNCTION),
            new SuggestionToken("context.getVariable()", FUNCTION),
            new SuggestionToken("context.getVariablesMap()", FUNCTION),
            ...
            new SuggestionToken("message.attributes()", FUNCTION),
            ...
            new SuggestionToken("message.content()", FUNCTION),
            ...
            new SuggestionToken("message.content.mimeType()", FUNCTION),
