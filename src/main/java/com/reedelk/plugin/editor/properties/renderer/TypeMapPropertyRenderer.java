...
public class TypeMapPropertyRenderer implements TypePropertyRenderer {
    ...
    public JComponent render(@NotNull Module module,
        ...
        JBTabbedPane tabbedPane = groupTabbedPane.orElseGet(JBTabbedPane::new);

        JComponent panel1 = new JPanel();
        panel1.add(new JLabel("Content"));
        tabbedPane.addTab(propertyDescriptor.getDisplayName(), Icons.Module, panel1, propertyDescriptor.getDisplayName());
    ...
    public void addToParent(@NotNull JComponent parent,
        ...
        // Otherwise we must register it and add  it  to the parent
    ...
    private Optional<JBTabbedPane> getGroupTabbedPane(ComponentPropertyDescriptor propertyDescriptor,
        ...
        if (tabGroup.isPresent()) {
            Optional<JComponent> componentMatchingMetadata =
                    context.getComponentMatchingMetadata((key, value) ->
                            TabGroup.class.getName().equals(key) &&
                                    tabGroup.get().equals(value));
