...
public class DynamicByteArrayPropertyRenderer extends AbstractTypePropertyRenderer {
    ...
    public JComponent render(@NotNull Module module,
        ...
        DynamicValueField field =
                new DynamicValueField(module, scriptContext, new ByteArrayInputFieldAdapter(hint));
        field.setValue(propertyAccessor.get());
        field.addListener(propertyAccessor::set);
        return field;
    }

    class ByteArrayInputFieldAdapter implements InputFieldAdapter {

        private StringInputField inputField;

        ByteArrayInputFieldAdapter(String hint) {
            inputField = new StringInputField(hint);
        }
