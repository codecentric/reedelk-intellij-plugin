...
import static de.codecentric.reedelk.plugin.editor.properties.metadata.RendererUtils.htmlTitle;
...
abstract class AbstractMetadataInputPanel extends DisposableScrollPane implements OnComponentMetadataEvent {
    ...
    static class MetadataError extends DisposablePanel {
        MetadataError(String errorMessage) {
            ...
            JBLabel label =
                    new JBLabel(RendererUtils.htmlTitle("An error occurred while fetching metadata for component: " + errorMessage, ""),
                            JLabel.CENTER);
